...
Я fullstack разработчик, уверенно работаю с MERN-стеком. Активно разрабатываю проекты - люблю продумывать архитектуру, писать чистый и удобный код, который легко масштабировать и поддерживать.
