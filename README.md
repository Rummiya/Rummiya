...
Я frontend-разработчик, уверенно работаю с MERN-стеком. Активно разрабатываю проекты - люблю продумывать архитектуру, писать чистый код, который легко масштабировать и поддерживать.
