...
Я frontend-разработчик, уверенно работаю с React и TypeScript. Активно разрабатываю проекты — стараюсь придерживаться лучшим практикам, люблю продумывать архитектуру, писать чистый код, который легко масштабировать и поддерживать.
